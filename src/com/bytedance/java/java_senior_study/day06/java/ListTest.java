 ...
 * 2.ArrayList的源码分析：
 *   2.1 jdk7的情况下：
 *     ArrayList arr = new ArrayList();//底层创建了长度是10的Object[] elementData数组
 ...
 *
 *   2.2 jdk8中ArrayList中的变化:
 *     ArrayList list = new ArrayList();//底层Object[] elementData初始化为{},并没有创建长度为10的数组
 *     list.add(123);//第一次调用add()时，底层才创建了长度为10的数组，并将数据123添加到elementData上
 *     ...
 *     后续的添加和扩容操作与jdk7无异。
 *   2.3 小结：jdk7中的ArrayList的创建类似于单例的饿汉式，而jdk8中的ArrayList的对象的创建类似于
