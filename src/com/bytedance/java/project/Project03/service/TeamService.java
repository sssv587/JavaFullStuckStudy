...
import com.bytedance.java.project.Project03.domain.Architect;
import com.bytedance.java.project.Project03.domain.Designer;
import com.bytedance.java.project.Project03.domain.Employee;
import com.bytedance.java.project.Project03.domain.Programmer;
...
public class TeamService {
    ...
    public void addMember(Employee e) throws TeamException {
        ...
        if ("BUSY".equalsIgnoreCase(p.getStatus().getNAME())) {
            ...
            throw new TeamException("员正在休假，无法添加");
        }
